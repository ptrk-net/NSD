    ...
    def NSD_Process_live_ICMP(self, queue):
        ...
        while True:
            try:
                ...
                NSD_Monitor_Data.NSD_Monitor_Data_increment_total_database_ICMP()
    ...
    def NSD_Process_live_TCP(self, queue):
        ...
        while True:
            try:
                ...
                # self.logger.info([Source_IP, Dest_IP, Source_Port, Dest_Port, Sequence_Number, ACK_Number, Data])
                ...
                NSD_Monitor_Data.NSD_Monitor_Data_increment_total_database_TCP()
            except UnicodeDecodeError as msg:
                self.logger.info('TCP Codec Error: ' + str(msg))
            except KeyboardInterrupt:
    ...
    def NSD_Process_live_UDP(self, queue):
        ...
        while True:
            try:
                ...
                # self.logger.info([Date, Source_IP, Dest_IP, Source_Port, Dest_Port, Data])
                self.DB.NSD_Database_insert_UDP_packet([Source_IP, Dest_IP, Source_Port, Dest_Port,
                                                        Length, Checksum, Data])

                NSD_Monitor_Data.NSD_Monitor_Data_increment_total_database_UDP()
            except UnicodeDecodeError as msg:
                self.logger.info('UDP Codec Error: ' + str(msg))
            except KeyboardInterrupt:
